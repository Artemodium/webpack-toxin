if ($(location).attr('pathname') == '/form-elements.html') {
    ...
    $('.show-hint').hide();
    $('.dropdown-default__content_default').hide();
    $('.dropdown-large__content_large').hide();
}
if ($(location).attr('pathname') == '/landing-page.html') {
    $('.dropdown-large__content_large').hide();
    $('.show-hint').hide()
}
...
if ($(location).attr('pathname') == '/form-elements.html' || '/landing-page.html' || "/search-room.html") {
